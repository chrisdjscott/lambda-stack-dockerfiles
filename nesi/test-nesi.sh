...
${SINGULARITY} python3 -c "import torch; print(torch.cuda.device_count())"
${SINGULARITY} python3 -c "import torch; print('torch version', torch.__version__)"
${SINGULARITY} python3 -c "import tensorflow; print('tensorflow version', tensorflow.__version__)"
